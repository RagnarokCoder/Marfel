...
class LineChartSample1State extends State<LineChartSample1> {
                                  ...
                                  child: AspectRatio(
                                    ...
                                    child: PieChart(
                                      PieChartData(
                                          ...
                                          sections: _checkboxValue1 == 0
                                              ? showingSections(ventasEnero,
                                                  gastosEnero, comprasEnero)
                                              : _checkboxValue1 == 1
                                                  ? showingSections(
                                                      totalVentas,
                                                      gastosFebrero,
                                ...
                                child: Marquee(
                                  child: Row(
                                    ...
                                    children: [
                                      //Enero
                                      Text(
                                          'Enero: \$${f.format(gananciaMesActual)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciaMesActual < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciaMesActual < 0
                                      ...
                                      //Febrero
                                      Text(
                                          'Febrero: \$${f.format(gananciasFeb)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasFeb < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasFeb < 0
                                      ...
                                      //Agosto
                                      Text(
                                          'Agosto: \$${f.format(gananciasAgo)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasAgo < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasAgo < 0
                                      ...
                                      //Septiembre
                                      Text(
                                          'Septiembre: \$${f.format(gananciasSep)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasSep < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasSep < 0
                                      ...
                                      //Octubre
                                      Text(
                                          'Octubre: \$${f.format(gananciasOct)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasOct < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasOct < 0
                                      ...
                                      //Noviembre
                                      Text(
                                          'Noviembre: \$${f.format(gananciasNov)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasNov < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasNov < 0
                                      ...
                                      //Diciembre
                                      Text(
                                          'Diciembre: \$${f.format(gananciasDic)}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: gananciasDic < 0
                                                  ? Colors.red
                                                  : Colors.green)),
                                      Icon(
                                          gananciasDic < 0
                          ...
                          children: [
                            ...
                            Icon(
                                gananciaAno < 0
                                    ...
                                    : Icons.arrow_drop_up,
                                color:
                                    gananciaAno < 0 ? Colors.red : Colors.green,
                                size: 25),
                          ],
                        )),
                    Container(
  ...
  bottonGenerar() {
    ...
    FirebaseFirestore.instance
        .collection("Ventas")
        .where("Año", isEqualTo: anoSeleccionado)
        .snapshots()
        .listen((result) {
  ...
  List<PieChartSectionData> showingSections(
      double ventas, double gastos, double compras) {
