...
class _NuevaOrdenState extends State<NuevaOrden> {
  ...
  Widget build(BuildContext context) {
      ...
      body: Stack(
        children: [
          Container(
            ...
            prodPart == false ?
            Column(
              mainAxisAlignment: selectedCurrency1 == null ? MainAxisAlignment.spaceAround: MainAxisAlignment.start,
              ...
              children: [
                ...
                Container(
                 ...
                 borderRadius: BorderRadius.all( Radius.circular(25))
                                ...
                                child: _currentSliderValue == 0? Image.asset("assets/sun.png"):Image.asset("assets/moon.png"),
                              ),
        ...
        setState(() {
          _currentSliderValue = value;
                ...
                Container(
                  ...
                  height: selectedCurrency1 == null ? MediaQuery.of(context).size.height*0.45:MediaQuery.of(context).size.height*0.25,
        ...
        onChanged: (newValue) {
          ...
          switch(drop1)
          {
            ...
            break;
                      ...
                      selectedCurrency1 != null ?SizedBox():
                      Container(
                ...
                children: [
                  InkWell(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: icono == false? colorPrincipal:Colors.white,
                    ),
                    child: Center(
                      child: Text("Agua",
                    style: TextStyle(
                      color: icono == false? Colors.white:colorPrincipal,
                      fontSize: 16,
                      fontWeight: FontWeight.bold
                    ),
                    ),
                  ...
                  InkWell(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: icono == true? colorPrincipal:Colors.white,
                    ),
                    child: Center(
                      child: Text("Leche",
                    style: TextStyle(
                      color: icono == true? Colors.white:colorPrincipal,
                      fontSize: 16,
                      fontWeight: FontWeight.bold
                    ),
                    ),
    ...
    icono == null ? SizedBox():
                                      ...
                                      DropdownButton(
                                        ...
                                        onChanged: (currencyValue) {
                                          ...
                                          setState(() {
                                            ...
                                            productos.add(currencyValue.toString());
                                            print(productos);
                                          });
                                        },
                ...
                materia != null && drop1 == 0 || drop1 == 2 || drop1 == 3 || drop1 == 4? 
                Container(
                            height: MediaQuery.of(context).size.height*0.08,
                            width: MediaQuery.of(context).size.width*0.35,
                            child: CustomDropdown(
        ...
        onChanged: (newValue) {
         ...
         print(numeroTambos);
                    ...
                    SizedBox(height: 15,),
                    selectedCurrency1 != null && drop1 == 2 || drop1 == 3 || drop1 == 4?
                    Container(
                            color: Colors.red,
                            margin: EdgeInsets.only(left: 20, right: 20),
                            child: _buildTextField(Icons.add, "Piezas", _piezasController),
                          ):SizedBox()
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            _buildTextField(Icons.add, "Maxi", _maxiController),
                            _buildTextField(Icons.add, "Hexagonal", _hexaController),
                            _buildTextField(Icons.add, "Cuadraleta", _cuadController),
                          ],
                        ),
                      ):
                      Container(
                      ...
                      FlatButton.icon(
                        ...
                        onPressed: (){
                          if(materia == "Agua" && categoria == "Paleta")
                          {
                            subirPaletaAgua();
                            buildAlert(context);
                          }
                          if(materia == "Leche" && categoria == "Paleta")
                          {
                            subirPaletaLeche();
                            buildAlert(context);
                          }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            _buildTextField(Icons.add, "5L", _fiveLController),
                            _buildTextField(Icons.add, "1L", _oneLController),
                          ],
                        ),
                      ),
      ...
      floatingActionButton: prodPart == false? FloatingActionButton.extended(
    ...
    child: Container(
      ...
      child: Center(
        child: Column(
          children: [
            SizedBox(height: 15,),
            Text("Orden De Producción Creada", style: (
                                      TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white
    ...
    child: Container(
      ...
      child: Center(
        child: Column(
          children: [
            SizedBox(height: 15,),
            Text("¿Desea Reiniciar La Orden De Producción", style: (
                                      TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white
      ...
      drop1 = null;
                ...
                icon: Icon(Icons.check, color: Color(0xff00cf8d),), 
                label: Text("Confirmar", style: TextStyle(color: Colors.white),)),
                RaisedButton.icon(
                color: Colors.transparent,
                elevation: 0,
