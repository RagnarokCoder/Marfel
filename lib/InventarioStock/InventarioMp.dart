                    ...
                    children: [
                      StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('InventarioMP')
                            .snapshots(),
                        builder: (context, snapshot) {
                          return Column(
                              children: snapshot.data.docs
                                  .map<Widget>((doc) => _buildInventario(doc))
                                  .toList());
                        },
                      ),
                    ],
                      ...
                      StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          return Column(
                              children: snapshot.data.docs
                                  .map<Widget>(
                                      (doc) => _buildComprasPendientes(doc))
                                  .toList());
                        },
                      ),
                    ],
                      ...
                      children: [
                        ...
                        FlatButton(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius:
                                  BorderRadius.all(Radius.elliptical(50, 75))),
                          color: colorPrincipal,
                          onPressed: () {
                            icono = false;
                            setState(() {});
              ...
              children: [
                ...
                Container(
                    ...
                    margin: const EdgeInsets.only(
                        left: 10,
                        right: 10,
                        bottom: 10), //Same as `blurRadius` i guess
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5.0),
                      color: Colors.white,
                      boxShadow: [
                              ...
                              documentReference.get().then((result) {
                                if (result.exists) {
                                  ...
                                  FirebaseFirestore.instance
                                      ...
                                      .set({
                                    "Cantidad":
                                        double.parse(doc.data()['Cantidad']),
