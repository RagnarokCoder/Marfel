  ...
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      result.docs.forEach((result) {
        setState(() {
          if(result.data()['Limitar']!=null && result.data()['Categoria'] == widget.categoria && result.data()['Pendiente'] == true)
          {
