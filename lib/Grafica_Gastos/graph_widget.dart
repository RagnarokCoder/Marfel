...
class GraphWidget2 extends StatefulWidget {
  final List<double> data;

  const GraphWidget2({Key key, this.data}) : super(key: key);
  @override
  _GraphWidget2State createState() => _GraphWidget2State();
}

class _GraphWidget2State extends State<GraphWidget2> {
